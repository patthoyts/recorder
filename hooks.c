...
/*
 * If Lua is enabled and a otr_timer function is available, call it.
 * The return value is the time to wait before the next call in milliseconds
 * However, note that we may get called before this time if data arrives before
 * the specified timeout.
 * Handle that here or in script?
 */
